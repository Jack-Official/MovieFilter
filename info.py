...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>🗂 ғιʟє ɴαмє </b> :-: <b><code>{file_name}</code></b>\n╔═══ ᴊᴏιɴ ωιτн υѕ ═══╗\n➲ [мονιє υᴘᴅατєѕ ](https://t.me/cinema_flix_updates)\n➲ [мονιє ɢʀουᴘ](https://t.me/Mallu_Movie_Hub_Group)\n╚═══ ᴊᴏιɴ ωιτн υѕ ═══╝</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", None)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>💌 ʀєϙυєѕτєᴅ ʙʏ : </b> <b>{message.from_user.mention}</b>\n\n<b>🍿 τιτʟє </b> : <b>{title}</b><b>\n📅 ʏєαʀ </b> :<b>{release_date}</b><b>\n🔊 ʟαɴɢυαɢє </b> : <b>{languages}</b><b>\n⏳ ɢєɴʀєѕ </b> : <b>{genres}</b><b>\n🎭 ʀατιɴɢ </b> : <b>{rating}</a> / 10</b>\n\n<b>❇️ ᴘοωєʀєᴅ ʙʏ</b> : <b>{message.chat.title}</b>")
