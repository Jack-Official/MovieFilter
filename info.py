...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b><u>🗂️ғɪʟᴇ ɴᴀᴍᴇ</u></b> : <b><code>{file_name}</code></b>\n<b><u>⚙️ғɪʟᴇ sɪᴢᴇ</b> : <b>{file_size}</u></b><b>\nതാഴെക്കാണുന്ന ചാനലുകളിൽ ജോയിൻ ആയെന്ന് ഉറപ്പുവരുത്തുക\n📮 ᴊᴏɪɴ : [ᴄʜᴀɴɴᴇʟ](https://t.me/cinema_flix_updates)\n🔖 ᴍᴏᴠɪᴇs : [ɢʀᴏᴜᴘ](https://t.me/+iEbhY7mM4oE1OTVl)\n🎗 ʝσιи • ѕнαяє • ѕυρρσят 🎗</b>")
