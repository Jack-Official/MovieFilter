...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, SINGLE_BUTTON, PROTECT_CONTENT, \
    SPELL_CHECK_REPLY, IMDB_TEMPLATE, IMDB_DELET_TIME, NO_RESULTS_MSG, START_MESSAGE, PMFILTER, G_FILTER, BUTTON_LOCK, SUPPORT_CHAT_ID, SUPPORT_CHAT, BUTTON_LOCK_TEXT, NOR_IMG
...
async def pm_next_page(bot, query):
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("✧ ƁAƇƘ", callback_data=f"pmnext_{req}_{key}_{off_set}"),
             InlineKeyboardButton(f"📄ᕈΔGE {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}", callback_data="pages")]                                  
        )
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("✧ ƁAƇƘ", callback_data=f"next_{req}_{key}_{off_set}"),
             InlineKeyboardButton(f"📄ᕈΔGE {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}",
                                  callback_data="pages")]
        )
    elif off_set is None:
        btn.append(
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            InlineKeyboardButton('⇆ αᴅᴅ мє το ʏουʀ ɢʀουᴘѕ ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
        ], [
            InlineKeyboardButton('👨‍💻 οωɴєʀ 👨‍💻', callback_data='suneesh'),
            InlineKeyboardButton('🎭 ɢʀουᴘ 🎭', url='https://t.me/Mallu_Movie_Hub_Group')  
        ], [
            InlineKeyboardButton('⚠️ нєʟᴘ ⚠️', callback_data='help2'),
            InlineKeyboardButton('🔰 αʙουτ 🔰', callback_data='about')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('τєʟєɢʀαᴘн', callback_data='tele'),
            InlineKeyboardButton('ғιʟє ѕτοєʀ', callback_data='newdata')         
            ],[
            InlineKeyboardButton('ϲοɴɴєϲτιοɴѕ', callback_data='coct'),
            InlineKeyboardButton('ғιʟτєʀ', callback_data='filters'),
            InlineKeyboardButton('єxτʀα-мοᴅѕ', callback_data='extra')   
            ],[
            InlineKeyboardButton('ѕнαʀє τєɴτ​', callback_data='sharetxt'),
            InlineKeyboardButton('υʀʟ ѕнοʀτ', callback_data='urlshort')
            ],[
            InlineKeyboardButton('ᴊsᴏɴє', callback_data='son'),
            InlineKeyboardButton('ѕτιϲκєʀ-ιᴅ', callback_data='sticker'),
            InlineKeyboardButton('ѕτατυѕ', callback_data='stats')
            ],[
            InlineKeyboardButton('🏘 нοмє', callback_data='start'), 
        ...
        buttons = [[
            InlineKeyboardButton('ϲαʀʙοɴ', callback_data='carb'),
            InlineKeyboardButton('мυѕιϲ', callback_data='song')
            ],[
            InlineKeyboardButton('ττѕ', callback_data='ttss'), 
            InlineKeyboardButton('ᴘαѕτє', callback_data='pastes'),
            InlineKeyboardButton('ᴘυʀɢє', callback_data='purges')                          
            ],[
            InlineKeyboardButton('zοмʙιє', callback_data='zombies'),
            InlineKeyboardButton('ғοɴτ', callback_data='fond'),
            ],[
            InlineKeyboardButton('мυτє', callback_data='restric'),
            InlineKeyboardButton('ᴅєᴘʟοʏ', callback_data='support'),
            InlineKeyboardButton('ᴘιɴ', callback_data='pin')
            ],[
            InlineKeyboardButton('⬅️ ʙαϲκ ', callback_data='help2'),
        ...
        buttons= [[
            InlineKeyboardButton('🏘 нοмє', callback_data='start'),
            InlineKeyboardButton('🧩 ѕυᴘᴘοʀτ', callback_data='source'),
            InlineKeyboardButton('ϲʟοѕє 🔐', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('« ʙαϲκ »', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('« ʙαϲκ »', callback_data='help2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('« ʙαϲκ »', callback_data='help3')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('« ʙαϲκ', callback_data='help2'),
            InlineKeyboardButton('ʀєғʀєѕн ♻️', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("ϲοɴταϲτ ☎️", url="https://t.me/TG_x_filter")
                  ]]
            reply_markup = InlineKeyboardMarkup(btn)
            await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton('мαɴυαʟ ғιʟτєʀ', callback_data="manuelfilter"),
                    InlineKeyboardButton('αυτο ғιʟτєʀ', callback_data="autofilter")
                    ],[
                    InlineKeyboardButton("« ʙαϲκ »", callback_data="start")
                  ]]
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            InlineKeyboardButton('« ʙαϲκ', callback_data='help2'),
            InlineKeyboardButton('ʙυττοɴѕ 🔘', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('« ʙαϲκ ', callback_data='help2'),
            InlineKeyboardButton('αᴅмιɴ 🤴', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('ɢʟοʙαʟ ғιʟτєʀ', callback_data='gfill'),
            InlineKeyboardButton('υѕєʀ & ϲнατ', callback_data='uschat')
            ],[
            InlineKeyboardButton('« ʙαϲκ »', callback_data='extra')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[            
            InlineKeyboardButton('« ʙαϲκ »', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
        ...
        if settings is not None:
            buttons = [
                ...
                [
                    InlineKeyboardButton('🤖𝗕𝗼𝘁 𝗣𝗺', callback_data=f'setgs#botpm#{settings["botpm"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗬𝗲𝘀' if settings["botpm"] else '🗑️ 𝗡𝗼',
                                         callback_data=f'setgs#botpm#{settings["botpm"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('📁𝗙𝗶𝗹𝗲 𝗦𝗲𝗰𝘂𝗿𝗲',
                                         callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗬𝗲𝘀' if settings["file_secure"] else '🗑️ 𝗡𝗼',
                                         callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('🌇𝗜𝗺𝗱𝗯', callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗬𝗲𝘀' if settings["imdb"] else '🗑️ 𝗡𝗼',
                                         callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('🕵️‍♂️𝗦𝗽𝗲𝗹𝗹 𝗖𝗵𝗲𝗰𝗸',
                                         callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗬𝗲𝘀' if settings["spell_check"] else '🗑️ 𝗡𝗼',
                                         callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('👥𝗪𝗲𝗹𝗰𝗼𝗺𝗲', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ 𝗬𝗲𝘀' if settings["welcome"] else '🗑️ 𝗡𝗼',
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        req = message.from_user.id if message.from_user else 0
        btn.append(
            [InlineKeyboardButton(text=f"📄ᕈΔGE 1/{math.ceil(int(total_results) / 6)}", callback_data="pages"),
    ...
    if imdb:
        ...
        cap = f"<b>💌 ʀєϙυєѕτєᴅ ʙʏ :-: {message.from_user.mention}</b>\n\n<b>🎪 τιτʟє :-: {search}</b>\n<b>📁 ғιʟєѕ :-: {str(total_results)}</b>\n\n<b>❇️ ᴘοωєʀєᴅ ʙʏ :-:{message.chat.title}</b>"
...
async def pm_spoll_choker(msg):
    ...
    await msg.reply("<b>❐ നിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്ന വല്ലതും ആണ് എങ്കിൽ.അതിൽ ക്ലിക്ക് ചെയ്യുക.\n\n❐ ι ϲουʟᴅɴ'τ ғιɴᴅ αɴʏτнιиɢ ʀєʟατєᴅ το ᴅιᴅ ʏου мєαи αɴʏ οɴє οғ τнєʀє?\n\n⚠️ɴʙ : ϲʟιϲκ τнє мονιє ɴαмє οɴʟʏ ᴅοɴ'τ υѕє ʏєαʀ ʙυττοɴ.</b>", reply_markup=InlineKeyboardMarkup(btn), reply_to_message_id=msg.id)
...
async def advantage_spell_chok(msg):
    ...
    movielist = list(dict.fromkeys(movielist))  # removing duplicates
    if not movielist:
        k = await msg.reply(f"<b>𝗜 𝗰𝗼𝘂𝗹𝗱𝗻'𝘁 𝗳𝗶𝗻𝗱 𝗮𝗻𝘆𝘁𝗵𝗶𝗻𝗴 𝗿𝗲𝗹𝗮𝘁𝗲𝗱 𝘁𝗼 𝘁𝗵𝗮𝘁. 𝗖𝗵𝗲𝗰𝗸 𝘆𝗼𝘂𝗿 𝘀𝗽𝗲𝗹𝗹𝗶𝗻𝗴</b>")
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    await msg.reply("<b>❐ നിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്ന വല്ലതും ആണ് എങ്കിൽ.അതിൽ ക്ലിക്ക് ചെയ്യുക.\n\n❐ ι ϲουʟᴅɴ'τ ғιɴᴅ αɴʏτнιиɢ ʀєʟατєᴅ το ᴅιᴅ ʏου мєαи αɴʏ οɴє οғ τнєʀє?\n\n⚠️ɴʙ : ϲʟιϲκ τнє мονιє ɴαмє οɴʟʏ ᴅοɴ'τ υѕє ʏєαʀ ʙυττοɴ.</b>",
                    reply_markup=InlineKeyboardMarkup(btn))
