...
╰─────────────────────</b>"""
    ...
    SOURCE_TXT = """<b>🔋ϲнαɴɴєʟѕ & ɢʀουᴘ мοᴅυʟє🔋

ϲοмᴘʟєτє мονιє ʀєǫυєѕτιɴɢ ɢʀουᴘ.
αʟʟ ʟαɴɢυαɢє мονιєѕ & ѕєʀιєѕ.
ʙοτ ѕυᴘᴘοʀτ ɢʀουᴘ.
ʙοτ υᴘᴅατєѕ ϲнαɴɴєʟ.</b>"""
...
<b>»👥 ɢʀουᴘ :-: {a}</b>
<b>»🆔 ɢ ιᴅ :-:  <code{b}</code></b>
<b>»🧲 ɢʀουᴘ υѕєʀɴαмє :-: @{c}</b>
<b>»🕵️‍♂️ τοταʟ мємʙєʀѕ :-: {d}</b>
<b>»👨‍💻 αᴅᴅєᴅ ʙʏ :-: {e}</b>
...
• sʜᴀʀᴇ ᴜs ғᴏʀ ᴍᴏʀᴇ ғᴇᴀᴛᴜʀᴇs"""
    ...
    TELE_TXT = """<b>🌆 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐏𝐇 🌆

ᴅο αѕ ʏου ωιѕн ωιτн [ telegra.ph ] мοᴅυʟє

𝐔𝐒𝐀𝐆𝐄

🌆 /telegraph : ѕєɴᴅ мє τнιѕ ϲοммαɴᴅ ʀєᴘʟʏ ωιτн ᴘιϲτυʀє οʀ νιᴅєο υɴᴅєʀ (5мʙ)

𝐍𝐎𝐓𝐄

⦁ τнιѕ ϲοммαɴᴅ ιѕ αναιʟαʙʟє ιɴ ɢʀουᴘ αɴᴅ ᴘмѕ.

⦁ τнιѕ ϲοммαɴᴅ ϲαɴ ʙє υѕєᴅ ʙʏ єνєʀʏοɴє.</b>"""
...
<b>єνєʀʏοиє ϲαɴ υѕє τнιѕ ϲοммαɴᴅ, ιғ ѕᴘαмιɴɢ нαᴘᴘєɴѕ ʙοτ ωιʟʟ αυτοмατιϲαʟʟʏ ʙαɴ ʏου ғʀοм τнє ɢʀουᴘ.</b>"""
    ...
    URLSHORT_TXT = """<b>⛓️𝐔𝐑𝐋 𝐒𝐇𝐎𝐑𝐓𝐍𝐄𝐑⛓️</b>

<b>τнιѕ ϲοммαɴᴅ нєʟᴘѕ ʏου το ѕнοʀτ α υʀʟ</b>

<b>𝐔𝐒𝐀𝐆𝐄</b>

<b>⦁ /short : υѕє τнιѕ ϲοммαɴᴅ ωιτн ʏουʀ ʟιɴκ το ɢєτ ѕнοʀτєᴅ ʟιɴκᴅ</b>
...
ѕοɴg ᴅοωɴʟοαᴅ мοᴅυʟє, ғοʀ τнοѕє ωнο ʟονє мυѕιϲ. ʏου ϲαɴ υѕє τнιѕ ғєατυє ғοʀ ᴅοωɴʟοαᴅ αɴʏ ѕοɴɢ ωιτн ѕυᴘєʀ ғαѕτ ѕᴘєєᴅ. ωοʀκѕ οɴʟʏ οɴ ɢʀουᴘѕ../

𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒

🎧/song : αɴᴅ ʏουʀ мυѕιϲ ɴαмє
